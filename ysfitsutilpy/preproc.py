...
def biascor(ccd, mbias=None, mbiaspath=None, copy=True, verbose=1):
    """Do bias correction (purpose: helper function of `~ysfitsutilpy.preproc.ccdred`)
...
def darkcor(
    ...
    """Do dark correction (purpose: helper function of `~ysfitsutilpy.preproc.ccdred`)
...
def flatcor(
    ...
    """Do flat correction (purpose: helper function of `~ysfitsutilpy.preproc.ccdred`)
