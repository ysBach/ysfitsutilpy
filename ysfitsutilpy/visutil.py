...
def znorm(image, stretch=LinearStretch(), **kwargs):
    warn("Using znorm in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
...
def zimshow(ax, image, stretch=LinearStretch(), cmap=None, **kwargs):
    warn("Using zimshow in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
    im = ax.imshow(image,
...
def norm_imshow(ax, data, stretch='linear', power=1.0, asinh_a=0.1,
    ...
    """
    warn("Using norm_imshow in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
...
def colorbaring(fig, ax, im, fmt="%.0f", orientation='horizontal',
    ...
    warn("Using colorbaring in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
...
def mplticker(ax_list,
    ...
    '''
    warn("Using mplticker in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
...
def linticker(ax_list,
              ...
              ymajgridkws=dict(ls='-', alpha=0.5),
              ymingridkws=dict(ls=':', alpha=0.5)):
    warn("Using linticker in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
    mplticker(**locals())
...
def logticker(ax_list,
              ...
              ymajgridkws=dict(ls='-', alpha=0.5),
              ymingridkws=dict(ls=':', alpha=0.5)):
    warn("Using logticker in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
    mplticker(**locals())
...
def logxticker(ax_list,
               ...
               ymajgridkws=dict(ls='-', alpha=0.5),
               ymingridkws=dict(ls=':', alpha=0.5)):
    warn("Using logxticker in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
    mplticker(**locals())
...
def logyticker(ax_list,
               ...
               ymajgridkws=dict(ls='-', alpha=0.5),
               ymingridkws=dict(ls=':', alpha=0.5)):
    warn("Using logyticker in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
    mplticker(**locals())
...
def linearticker(ax_list, xmajlocs, xminlocs, ymajlocs, yminlocs,
    ...
    warn("Using linearticker in ysfitsutilpy is deprecated. "
         + "Please use ysvisutilpy.")
